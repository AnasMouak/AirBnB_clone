...
class TestCodeStyle(unittest.TestCase):
    """Unittests for checking the PEP8 compliance of console.py."""
...
class TestHBNBCommand_prompting(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(self):
        """Prepares test environment before executing tests."""
    ...
    def test_docstrings_in_console(self):
        """Checks for console.py docstrings."""
        self.assertTrue(len(console.__doc__) >= 1)

    def test_docstrings_in_test_console(self):
        """Verifies test_console.py has docstrings."""
        self.assertTrue(len(self.__doc__) >= 1)

    def test_prompt_string(self):
        """Ensures prompt string is as expected."""
        self.assertEqual("(hbnb) ", HBNBCommand.prompt)

    def test_empty_line(self):
        """Confirms empty line doesn't execute anything."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Tests help command outputs."""

    def test_help_quit(self):
        """Tests 'help quit'."""
        h = "Exits the console. Usage: quit"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_EOF(self):
        """Tests 'help EOF'."""
        h = "Exits console with EOF (Ctrl+D)."
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_destroy(unittest.TestCase):
    ...
    def test_destroy_missing_class(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            ao = output.getvalue().strip()
            self.assertEqual(
                expected_output_missing_class_name, ao,
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            ao = output.getvalue().strip()
            self.assertEqual(
                expected_output_class_doesnt_exist, ao,
...
class TestHBNBCommand_count(unittest.TestCase):
    """Tests counting class instances."""
